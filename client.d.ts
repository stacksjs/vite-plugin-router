declare module "vue-router/auto-routes" {
  ...
  /**
   * Array of routes generated by vite-plugin-router
   */
...
declare module "vue-router/auto" {
  // reexport all types that are not augmented by vite-plugin-router
  ...
  // export { defineBasicLoader } from 'vite-plugin-router/data-loaders/basic'
  // export { defineColadaLoader } from 'vite-plugin-router/data-loaders/pinia-colada'
}

// Make the macros globally available
declare global {
  const definePage: (typeof import("vite-plugin-router/runtime"))["definePage"];
}
